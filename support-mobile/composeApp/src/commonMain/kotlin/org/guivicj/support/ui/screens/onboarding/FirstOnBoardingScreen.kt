    ...
    MaterialTheme {
        Scaffold {
            ...
            Column(
                ...
                Text(
                    text = stringResource(Res.string.first_onboarding_subtitle),
                    style = MaterialTheme.typography.bodyMedium,
                    color = MaterialTheme.colorScheme.surface
                )
                Spacer(modifier = Modifier.weight(1f))
                OutlinedButton(
                    onClick = { navController.navigate(Screen.SecondOnBoardingScreen.route) },
                    ...
                    Text(
                        text = stringResource(Res.string.first_onboarding_button),
                        style = MaterialTheme.typography.bodyMedium
                    )
                }
            }
