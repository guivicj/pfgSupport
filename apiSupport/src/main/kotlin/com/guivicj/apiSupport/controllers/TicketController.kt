...
class TicketController(val ticketService: TicketService) {
    ...
    fun escalateTicket(@PathVariable ticketId: Long, @RequestBody request: EscalateTicketRequest
    ...
    fun changeState(@PathVariable ticketId: Long, @RequestBody request: ChangeStateRequest
    ): ResponseEntity<TicketDTO> {
